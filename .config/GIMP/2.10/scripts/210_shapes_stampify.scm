...
(define (210-stampify img drawable paper hole diameter gap marg)
		(let*	(
			...
			(layer1 (car (gimp-layer-new img2 nw nh 0 "Layer1" 100 LAYER-MODE-NORMAL-LEGACY)))
			(nholes 0)
			(pos 0)
			(i 0)
			(dist 0)
...
(script-fu-register "210-stampify"
	"<Image>/Script-Fu/Shapes/Stampify"
