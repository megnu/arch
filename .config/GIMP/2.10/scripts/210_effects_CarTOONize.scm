...
(define (210-CarTOONize
  ...
  (let* (
	 ...
	 (layer-temp1 (car (gimp-layer-new toon-img width height 0 "temp1"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp2 (car (gimp-layer-new toon-img width height 0 "temp2"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp3 (car (gimp-layer-new toon-img width height 0 "temp3"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp2a (car (gimp-layer-new toon-img width height 0 "temp2a"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp4 (car (gimp-layer-new toon-img width height 0 "temp4"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp5 (car (gimp-layer-new toon-img width height 0 "temp5"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp6 (car (gimp-layer-new toon-img width height 0 "temp6"  100 LAYER-MODE-NORMAL-LEGACY)))
	 (layer-temp7 (car (gimp-layer-new toon-img width height 0 "temp7"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-gmic (car (gimp-layer-new toon-img width height 0 "gmic"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-cartoonize (car (gimp-layer-new img width height 0 "CarTOONize"  100 LAYER-MODE-NORMAL-LEGACY)))
 	 (layer-comic (car (gimp-layer-new img width height 0 "Comic-strip"  100 LAYER-MODE-NORMAL-LEGACY)))
         (cdepth (* 4 cdepth))     
         (isfiltered  FALSE)
      ) 
    ...
    (if (eqv? (car (gimp-selection-is-empty toon-img)) TRUE)
        (gimp-drawable-fill old-selection 2)) 
	...
	; punches up contrqwt just a bit
	(gimp-brightness-contrast layer-temp2 -3 3)
...
(script-fu-menu-register "210-CarTOONize" "<Image>/Script-Fu/Effects/")
