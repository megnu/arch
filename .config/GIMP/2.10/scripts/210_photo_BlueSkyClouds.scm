...
(define (210-BlueSkyClouds 
	...
	(let*	(
		...
		(gimp-edit-blend BlueGradientLayer FG-BG-RGB-MODE LAYER-MODE-NORMAL-LEGACY GRADIENT-LINEAR 100 0 REPEAT-NONE FALSE FALSE 0 0 TRUE 0 0 0 (- TheHeight 1))
