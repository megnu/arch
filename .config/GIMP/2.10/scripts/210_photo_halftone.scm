...
(script-fu-register "210_photo_halftone"
	...
	SF-OPTION "Dithering Option" '("Floyd-Steinberg (Normal)" "Positioned" "None" "Floyd Steinberg (Reduced Color Bleeding)")     
