; 210_sharpness-sharper_high-pass-sharpen.scm
; last modified/tested by Paul Sherman [gimphelp.org]
; 09/12/2018 on GIMP 2.10.6
;==================================================
;
; Installation:
...
(script-fu-register 
	"210-highpass-sharpen"
	"<Image>/Script-Fu/Sharpness/Sharper/High-Pass Sharpen"
	...
	SF-TOGGLE     "Overlay (sharpen)"   TRUE
)